...
###Description
This is the call to action 3 option.
...
To implement the call to action 3 option, use the markup structure shown here, with the cta-blue cta-image-top.
