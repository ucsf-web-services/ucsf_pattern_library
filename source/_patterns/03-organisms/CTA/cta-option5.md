...
###Description
This is the call to action 5 option.
...
To implement the call to action 5 option, use the markup structure shown here, with the cta cta-gray cta-offset-image.
